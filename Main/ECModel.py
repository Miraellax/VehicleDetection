...
# Read dict from path
weights_dict = np.load(absolute_path + '/resources/model_weight_dict.npy', allow_pickle=True).item()
class ECModel(QObject):
    ...
    def process_image(self, image: PIL):
        ...
        # Detections(
        #   xyxy=array([[46.362, 43.064, 233.17, 129.77]], dtype=float32),
        #   mask=None,
        #   confidence=array([0.94702], dtype=float32),
        #   class_id=array([1]),
        #   tracker_id=None
        # )
